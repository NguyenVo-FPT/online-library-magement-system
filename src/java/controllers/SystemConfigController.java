...
public class SystemConfigController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList configList = scd.getList();
  
        if (configList != null) {
            request.setAttribute("list", configList);
            request.getRequestDispatcher("/jsp/system_config.jsp").forward(request, response);
        }
        else {
            response.getWriter().print("List null ban code ngu vai l");
        }
